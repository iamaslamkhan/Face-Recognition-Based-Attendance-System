    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/Users/aslam/Downloads/Project/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:/Users/aslam/Downloads/Project/Attendance/Manually Attendance/-------Check atttendance-------"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Users/aslam/Downloads/Project/Attendance/' + fileName
    ...
    def log_in():
        ...
        if username == 'Aslam' :
            if password == 'Aslam123':
                ...
                cs = 'C:/Users/aslam/Downloads/Project/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
